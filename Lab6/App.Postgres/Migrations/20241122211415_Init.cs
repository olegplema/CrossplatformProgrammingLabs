        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateMovedOut = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOrderPlaced = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DateOrderDelivered = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateShipped = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    OtherDetails = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 11, 25, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8860), new DateTime(2024, 11, 20, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8800), "First Order Details", "Pending" },
                    { 2, 2, new DateTime(2024, 11, 21, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8870), new DateTime(2024, 11, 17, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8860), "Second Order Details", "Shipped" }
                });

            migrationBuilder.InsertData(
                table: "CreditNotes",
                columns: new[] { "CreditNoteId", "CreditNoteDate", "OrderId" },
                values: new object[] { 1, new DateTime(2024, 11, 21, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8950), 2 });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceId", "InvoiceDate", "InvoiceStatusCode", "OrderId", "OtherDetails" },
                values: new object[] { 1, new DateTime(2024, 11, 21, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8940), "Paid", 1, "Invoice for Order 1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 11, 21, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8900), 1, "Shipped via FedEx", "TRACK12345" },
                    { 2, new DateTime(2024, 11, 22, 23, 14, 15, 475, DateTimeKind.Local).AddTicks(8910), 2, "Shipped via UPS", "TRACK67890" }
                });
