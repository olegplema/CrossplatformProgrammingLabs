        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganisationOrPerson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOrderDelivered = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    InvoiceStatusCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    OrderItemStatusCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceShipmentItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InvoiceId = table.Column<int>(type: "int", nullable: false),
                    ShipmentId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CreditNoteReturnItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreditNoteId = table.Column<int>(type: "int", nullable: false),
                    ShipmentItemId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 11, 25, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6790), new DateTime(2024, 11, 20, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6740), "First Order Details", "Pending" },
                    { 2, 2, new DateTime(2024, 11, 21, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6790), new DateTime(2024, 11, 17, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6790), "Second Order Details", "Shipped" }
                });

            migrationBuilder.InsertData(
                table: "CreditNotes",
                columns: new[] { "CreditNoteId", "CreditNoteDate", "OrderId" },
                values: new object[] { 1, new DateTime(2024, 11, 21, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6880), 2 });

            migrationBuilder.InsertData(
                table: "Invoices",
                columns: new[] { "InvoiceId", "InvoiceDate", "InvoiceStatusCode", "OrderId", "OtherDetails" },
                values: new object[] { 1, new DateTime(2024, 11, 21, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6860), "Paid", 1, "Invoice for Order 1" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 11, 21, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6830), 1, "Shipped via FedEx", "TRACK12345" },
                    { 2, new DateTime(2024, 11, 22, 23, 2, 38, 593, DateTimeKind.Local).AddTicks(6830), 2, "Shipped via UPS", "TRACK67890" }
                });
